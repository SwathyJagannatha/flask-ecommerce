...
class CustomerForm extends Component {
  ...
  render() {
    const { name, email, phone, isLoading, error, errors, showSuccessModal } =
      this.state;
    ...
    return (
      <Container className="py-4 mt-2">
        ...
        <Form className="py-4 mt-3 bg-light" onSubmit={this.handleSubmit}>
        ...
        <Modal show={showSuccessModal} onHide={this.closeModal}>
          ...
          <Modal.Body>
            ...
            {this.state.selectedCustomerId ? "updated" : "added"}.
          </Modal.Body>
          <Modal.Footer>
